  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white font-sans">
      ...
      <section className="relative h-screen overflow-hidden pt-16">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight">
                Learn <span className="text-amber-400">Quran</span> & Islamic <br className="hidden sm:block" />
                <span className="text-teal-300">Studies Online</span>
              </h1>
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-200 mb-8 sm:mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <button
                  ...
                  className="bg-gradient-to-r from-amber-500 to-orange-500 text-slate-900 px-6 sm:px-10 py-4 sm:py-5 rounded-xl text-lg sm:text-xl font-bold hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
                >
                  Apply for Admission Now
                </button>
                <button
                  onClick={() => document.getElementById('courses')?.scrollIntoView({ behavior: 'smooth' })}
                  className="bg-white/10 backdrop-blur-lg text-white px-6 sm:px-10 py-4 sm:py-5 rounded-xl text-lg sm:text-xl font-bold border-2 border-white/20 hover:bg-white/20 transition-all duration-300"
                >
                  View All Courses
                </button>
              </div>
        ...
        {/* Image Indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-4">
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 sm:mb-8">
              <School className="w-8 h-8 sm:w-12 sm:h-12 text-white" />
            </div>
            ...
            <div className="mt-8 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
              <div className="text-center p-4">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-teal-600 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <User className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
                <h4 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Free Trial Class</h4>
                <p className="text-xs sm:text-sm text-slate-300">Experience teaching style first</p>
              </div>
              <div className="text-center p-4">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <DollarSign className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
                <h4 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Flexible Fees</h4>
                <p className="text-xs sm:text-sm text-slate-300">Pay what you can afford</p>
              </div>
              <div className="text-center p-4">
                ...
                <h4 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Flexible Timing</h4>
                <p className="text-xs sm:text-sm text-slate-300">Choose your preferred schedule</p>
              </div>
              <div className="text-center p-4">
                ...
                <h4 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2">Start Anytime</h4>
                <p className="text-xs sm:text-sm text-slate-300">No fixed academic year</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* Courses Section */}
      <section id="courses" className="py-16 sm:py-24 bg-gradient-to-b from-white to-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
            {courses.map((course, index) => (
              <motion.div
                ...
                className="group bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100"
              >
                <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 ${course.color === 'teal' ? 'bg-gradient-to-br from-teal-100 to-teal-50' :
                ...
                <div className="flex justify-between items-start mb-3 sm:mb-4">
                  ...
                  <span className={`px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs font-medium ${course.level === 'Beginner' ? 'bg-green-100 text-green-700' :
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {course.features.slice(0, 3).map((feature, idx) => (
                      <li key={idx} className="flex items-start text-xs sm:text-sm text-slate-700">
                        <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 text-teal-500 mr-1 sm:mr-2 mt-0.5 shrink-0" />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-teal-600 to-teal-700 text-white py-2.5 sm:py-3 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 transform group-hover:-translate-y-1 text-sm"
                >
                  Enroll Now
                </button>
              </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-12 sm:mt-16 bg-gradient-to-r from-teal-50 to-emerald-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-teal-200"
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center">
                ...
                <h4 className="text-lg sm:text-xl font-bold text-slate-800 mb-1 sm:mb-2">Qualified Teachers</h4>
                <p className="text-sm text-slate-600">All courses taught by certified Islamic scholars and Huffaz</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <GlobeIcon className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-slate-800 mb-1 sm:mb-2">Worldwide Access</h4>
                <p className="text-sm text-slate-600">Learn from anywhere in the world with flexible timings</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Award className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-slate-800 mb-1 sm:mb-2">Certification</h4>
                <p className="text-sm text-slate-600">Receive recognized certificates upon course completion</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* Articles Section */}
      <section id="articles" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-800 mb-4 sm:mb-6">
              تازہ ترین <span className="text-green-600">اسلامی آرٹیکلز</span>
            </h2>
            <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto">
              ہمارے علماء کی جانب سے اسلامی موضوعات پر تعلیمی آرٹیکلز اور بصیرت
            </p>
          </motion.div>
          ...
          {isLoadingArticles ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xl sm:text-2xl text-slate-500 font-medium mb-4">
                آرٹیکلز جلد ہی شامل کیے جائیں گے
              </p>
              <p className="text-slate-400">
                ہمارے علماء نئے آرٹیکلز تیار کر رہے ہیں
              </p>
            </div>
          ) : (
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                {homeArticles.slice(0, 6).map((article, index) => (
                  <motion.article
                    ...
                    transition={{ delay: index * 0.1 }}
                    whileHover={{ y: -5 }}
                    className="group bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100"
                  >
                      ...
                      {article.thumbnail ? (
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.src = "https://images.unsplash.com/photo-1567958451986-2c8f4eb6b2b3?w=800&auto=format&fit=crop";
                          }}
                        />
                      ) : (
                    ...
                    <div className="p-6">
                      ...
                      <Link
                        ...
                        className="block mt-2 text-xl font-bold text-green-700 hover:text-green-900 transition-colors line-clamp-2"
                      >
                      ...
                      <div className="mt-4 flex justify-between items-center text-gray-500 text-sm">
                        <span>
                          تحریر: <strong>{article.author || 'ایڈمن'}</strong>
                        </span>
                        <span>
                          {article.createdAt || article.date ? 
                            new Date(article.createdAt || article.date).toLocaleDateString('ur-PK', {
                              year: 'numeric',
                              month: 'short',
                              day: 'numeric',
                            }) : 'تازہ'
              ...
              <div className="text-center mt-12">
                <Link
                  href="/articles"
                  className="inline-flex items-center bg-gradient-to-r from-green-600 to-emerald-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
                  تمام آرٹیکلز دیکھیں
      ...
      {/* Stats Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-r from-teal-700 via-emerald-600 to-teal-800">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12">
            ...
            >
              <div className="w-24 h-24 sm:w-32 sm:h-32 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 backdrop-blur-lg">
                <Users className="w-10 h-10 sm:w-16 sm:h-16 text-white" />
              </div>
              <h3 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 sm:mb-4">
                {counters.enrolled}+
              </h3>
              <p className="text-lg sm:text-2xl text-teal-100 font-medium">
                Enrolled Students
              </p>
            </motion.div>
            <motion.div
            ...
            >
              <div className="w-24 h-24 sm:w-32 sm:h-32 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 backdrop-blur-lg">
                <GraduationCap className="w-10 h-10 sm:w-16 sm:h-16 text-white" />
              </div>
              <h3 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 sm:mb-4">
                {counters.teachers}+
              </h3>
      ...
      {showAdmissionForm && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-teal-700 to-emerald-700 text-white p-4 sm:p-6 rounded-t-xl sm:rounded-t-2xl flex justify-between items-center">
              <div>
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold">Admission Application Form</h2>
                <p className="text-teal-100 text-sm sm:text-base">Join Quran & Islamic Academy Online</p>
              </div>
              <button
                onClick={() => setShowAdmissionForm(false)}
                className="text-white hover:text-amber-300 text-xl sm:text-2xl"
              >
                ✕
              </button>
            </div>
            <div className="p-4 sm:p-6 lg:p-8">
              {admissionStatus === 'success' && (
                <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl">
                  <div className="flex items-center text-emerald-700">
                    <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 mr-3 sm:mr-4" />
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">Application Submitted Successfully!</h3>
                      <p className="text-sm sm:text-base">{admissionMessage}</p>
                      <p className="text-xs sm:text-sm mt-1 sm:mt-2 text-emerald-600">
              ...
              {admissionStatus === 'error' && (
                <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl">
                  <div className="flex items-center text-red-700">
                    <span className="text-lg sm:text-xl font-bold">{admissionMessage}</span>
                  </div>
                </div>
              )}
              <form onSubmit={handleAdmissionSubmit} className="space-y-4 sm:space-y-6">
                {/* Personal Information Section */}
                <div className="bg-gradient-to-r from-teal-50 to-emerald-50 p-4 sm:p-6 rounded-xl border border-teal-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border-2 border-teal-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all outline-none"
                    ...
                    <div className="sm:col-span-2">
                      <label className="block text-xs sm:text-sm font-medium text-amber-700 mb-1 sm:mb-2">
                        Referral code (Optional)
                      </label>
                      <input
                        type="text"
                        name="referralCode"
                        value={admissionForm.referralCode || ''}
                        onChange={handleAdmissionInputChange}
                        placeholder="مثال: OWNER-ABC123 یا TEACHER-XYZ456"
                        className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border-2 border-amber-200 rounded-xl focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all outline-none"
                      />
                    </div>
                    <div className="sm:col-span-2">
                      <label className="block text-xs sm:text-sm font-medium text-teal-700 mb-1 sm:mb-2">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 sm:p-6 rounded-xl border border-blue-200">
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4 flex items-center">
                    <Book className="w-5 h-5 sm:w-6 sm:h-6 mr-2" />
                    Course Selection
                  </h3>
                  <div>
                    <label className="block text-xs sm:text-sm font-medium text-blue-700 mb-1 sm:mb-2">
                      Select Course *
                    </label>
                    <select
                      name="selectedCourse"
                      ...
                      onChange={handleAdmissionInputChange}
                      required
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border-2 border-blue-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
                    >
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-4 sm:p-6 rounded-xl border border-amber-200">
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4 flex items-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <div className="flex">
                        <select
                          ...
                          onChange={handleAdmissionInputChange}
                          required
                          className="w-1/4 px-2 py-2 sm:px-4 sm:py-3 bg-white border-2 border-amber-200 rounded-l-xl border-r-0 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all outline-none"
                        >
                        ...
                        <input
                          ...
                          min="0"
                          step="0.01"
                          className="w-3/4 px-3 py-2 sm:px-4 sm:py-3 bg-white border-2 border-amber-200 rounded-r-xl focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all outline-none"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleAdmissionInputChange}
                        rows={3}
                        className="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border-2 border-amber-200 rounded-xl focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all outline-none resize-none"
                ...
                <div className="p-4 sm:p-6 bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl border border-slate-200">
                  <div className="flex items-start">
                    <input
                      type="checkbox"
                      id="terms"
                      required
                      className="mt-1 mr-3 w-4 h-4 sm:w-5 sm:h-5 text-teal-600 rounded focus:ring-teal-500"
                    />
                    <label htmlFor="terms" className="text-sm sm:text-base text-slate-700">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-8 sm:px-12 py-3 sm:py-4 rounded-xl text-lg sm:text-xl font-bold hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:-translate-y-1"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-6 sm:mb-8">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
              ...
              <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 max-w-xl">
              ...
              <div className="flex space-x-3 sm:space-x-4">
                <a href="#" className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-800 hover:bg-teal-600 rounded-xl flex items-center justify-center transition-all hover:scale-110">
                ...
                <a href="mailto:info@academy.com" className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-800 hover:bg-teal-600 rounded-xl flex items-center justify-center transition-all hover:scale-110">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-teal-300">Quick Links</h4>
              <ul className="space-y-3 sm:space-y-4">
                <li>
                  <Link href="/" className="text-slate-300 hover:text-teal-400 text-base sm:text-lg transition-colors">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/courses" className="text-slate-300 hover:text-teal-400 text-base sm:text-lg transition-colors">
                    Courses
                  </Link>
                </li>
                <li>
                  <Link href="/articles" className="text-slate-300 hover:text-teal-400 text-base sm:text-lg transition-colors">
                    Articles
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="text-slate-300 hover:text-teal-400 text-base sm:text-lg transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-slate-300 hover:text-teal-400 text-base sm:text-lg transition-colors">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-teal-300">Contact Us</h4>
              <ul className="space-y-4 sm:space-y-6">
                <li className="flex items-start">
                  <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-teal-400 mr-3 mt-0.5" />
                  <span className="text-base sm:text-lg text-slate-300">+92 3029151107</span>
                </li>
                <li className="flex items-start">
                  <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-teal-400 mr-3 mt-0.5" />
                  <span className="text-base sm:text-lg text-slate-300">msajidjami063@gmail.com</span>
                </li>
                <li className="flex items-start">
                  <Globe className="w-5 h-5 sm:w-6 sm:h-6 text-teal-400 mr-3 mt-0.5" />
                  <span className="text-base sm:text-lg text-slate-300">Online Classes Worldwide</span>
                </li>
              </ul>
            </div>
          </div>
          
          <div className="border-t border-slate-700 mt-12 sm:mt-16 pt-6 sm:pt-8 text-center">
