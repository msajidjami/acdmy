...
import PageLoggerModal from './PageLoggerModal';
...
export default function TeacherZoomClassroom({
  ...
  /* ✅ Book progress state (updates after each save) */
  ...
  /* Whether this class has a book attached */
  ...
  async function leaveClass() {
    ...
    /* ✅ If class has a book, open Page Logger */
  ...
  /* ------------------ Log Pages (open manually) ------------------ */

  const openPageLogger = () => {
    if (!hasBook) return;
    setShowPageLogger(true);
  };
  ...
  const bookPercent =
    totalPages > 0 ? Math.min(100, Math.round((pagesDone / totalPages) * 100)) : 0;
  ...
  return (
    <>
        ...
        <div className="border-b border-white/10 bg-slate-900/80 backdrop-blur-xl">
          ...
          <div className="flex items-center justify-between gap-3 px-3 sm:px-5 py-3">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              {/* ✅ Log Pages button (only when book exists) */}
              {hasBook && (
                <button
                  type="button"
          ...
          {status === 'idle' && (
            <div className="absolute inset-0 flex items-center justify-center p-4">
              <div className="text-center max-w-sm">
                ...
                {/* ✅ Manual "Log Pages" for idle state */}
                {hasBook && (
                  <button
                    type="button"
                    onClick={openPageLogger}
      ...
      {showWhiteboard && (
        <AdvancedWhiteboard onClose={() => setShowWhiteboard(false)} />
      )}
